...
const private = true;
console.log("Is Internet Private?",private);
...
let total = (Disney+Hulu+YouTube+Netflix+Peacock);
...
let newTotal = (Disney+Hulu+YouTube+Netflix+Peacock);
console.log ("New Subscription $", newTotal)
...
console.log ("You are saving ",savings.toFixed(2),"%");
